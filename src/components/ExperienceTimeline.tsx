      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            <div className="absolute left-3.5 sm:left-4 top-2 bottom-2 w-px bg-gradient-to-b from-blue-500/50 via-indigo-500/40 to-transparent" />

            {experiences.map((exp) => (
              <div key={exp.id} className="relative pl-10 sm:pl-12 pb-10 last:pb-0">
                <div className="absolute left-0 top-2 w-7 h-7 sm:w-9 sm:h-9 rounded-full border border-white/10 bg-zinc-950 flex items-center justify-center">
                  <div
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:bg-white/[0.05] hover:border-indigo-500/30 transition-all duration-300">
