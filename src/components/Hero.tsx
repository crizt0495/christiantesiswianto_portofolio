        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-14 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-bold text-zinc-100 leading-[1.1] mb-6 tracking-tight"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-base sm:text-lg text-zinc-400 leading-relaxed mb-9 max-w-xl"
            >
          ...
          >
            <div
              className="absolute -inset-8 bg-gradient-to-br from-blue-500/20 via-indigo-500/10 to-violet-500/20 blur-3xl"
              aria-hidden="true"
            />
            <div className="relative animate-float rounded-2xl border border-white/10 bg-zinc-950/80 backdrop-blur-xl shadow-2xl shadow-indigo-950/50 overflow-hidden">
            ...
            <div className="absolute -top-6 -right-4 animate-float-delayed card-hover rounded-xl border border-white/10 bg-zinc-900/90 backdrop-blur px-4 py-2.5 flex items-center gap-2.5 shadow-xl">
              <span className="text-xs font-semibold text-zinc-100">REST API</span>
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400" />
            </div>
            <div className="absolute -bottom-6 -left-6 animate-float rounded-xl border border-white/10 bg-zinc-900/90 backdrop-blur px-4 py-2.5 flex items-center gap-2.5 shadow-xl">
              <span className="text-xs font-semibold text-zinc-100">PostgreSQL</span>
